...
INSERT INTO Tour VALUES (
	...
	1289.75, 10, 0,'USD',3, 'xrtoAb~uxLjnAbiGoy@nwDyvDtcA|l@l{B}aD|nDprAtjD', 'BBBBBBB'
);
...
INSERT INTO Tour VALUES (
	...
	1399.35, 10, 1,'AUD',4, 'shyvGyjgi@koKpaMtfA~nD', 'BBB'
);
...
INSERT INTO Tour VALUES (
	...
	1679.95, 12, 0,'AUD',4, 'ej}|Dnmtm@jcThdPb{Kxl[l~D~vXqzQnuP', 'BBBBB'
);
...
INSERT INTO Tour VALUES (
	...
	1899.95, 14, 1,'AUD',2, '{}xkFkn_|AcX~MoK`]wTtW', 'BBBB'
);
...
INSERT INTO Tour VALUES (
	...
	1519.95, 10, 0,'AUD',3, 'eor~EmyvpD{^fB_^qGq`@rW', 'BBBB'
);
...
INSERT INTO Tour VALUES (
	...
	1899.95, 10, 0,'AUD',5, '_wto@{nzvQgCqd@{Umb@kEia@', 'BBBB'
);
...
INSERT INTO Tour VALUES (
	...
	999.95, 9, 1,'EUR',6, '`bhr@o{o`U_xBg}@~OwX{uBmTu`BsV', 'BBBBB'
);
...
INSERT INTO Tour VALUES (
	...
	1899.95, 8, 1,'EUR',7, '~ldCalq}LucAu_CmbF_mE', 'BBB'
);
...
INSERT INTO Tour VALUES (
	...
	1999.95, 10, 0,'EUR',8, 'l~fAqtl{Emc@fQkp@sHqs@bAkp@hC', 'BBBBB'
);
...
INSERT INTO Tour VALUES (
	...
	2899.95, 23, 1,'AUD',9, 'k|{k@qx{fAgi]yeX{w\xeXcgCxs^i_PhvI', 'BBBBB'
);
...
INSERT INTO Tour VALUES (
	...
	2699.95, 16, 1,'AUD',10, '_}ihA{mjmFgo@mEiZb^eX_Nyz@npA', 'BBBBB'
);
...
INSERT INTO Tour VALUES (
	...
	1099.95, 9, 0,'AUD',9, '~oegGardyZczMrqGylOxpNuyF~sH', 'BBBB'
);
...
INSERT INTO Tour VALUES (
	...
	1999.95, 14, 0,'AUD',8, 'wi{dD}wk{M~CbDfD~I|DzOtEnFvDfJ|ErD', 'BBBBBBB'
);
...
INSERT INTO Tour VALUES (
	...
	1099.95, 8, 0,'AUD',8, 'ygnPmadjTs{Dox`@iiKguf@q{Dcv_@', 'BBBB'
);
...
INSERT INTO Tour VALUES (
	...
	1599.95, 30, 1,'EUR',7, 'uhfvCi|paTba@udAtIi`@c_@urA', 'BBBB'
);
...
INSERT INTO Tour VALUES (
	...
	2099.95, 18, 0,'AUD',7, 'slgfG{i|}Qg|{@fhjBtbBff}@cyaA~hR_iYria@m`d@fzcB', 'BBBBBB'
);
...
INSERT INTO Tour VALUES (
	...
	1099.95, 9, 0,'AUD',5, 'f|wyCgkl}WgVqqRslAybHooFquEgyDpnB', 'BBBBB'
);
...
INSERT INTO Tour VALUES (
	...
	1899.95, 10, 1,'EUR',12, 'a}k~EssjhYgPsV}Qa]i\{K', 'BBBB'
);

-- ListedTour -----------------------------------------------------------------------

INSERT INTO ListedTour VALUES (
	0001, 0003, 0001, TO_DATE('12052010', 'DDMMYYYY'), TO_DATE('12052010', 'DDMMYYYY')  
);
...
INSERT INTO TourDate VALUES (
	0001, 0001, TO_DATE('11/06/2010', 'DD/MM/YYYY'), TO_DATE('13/06/2010', 'DD/MM/YYYY')  
);

INSERT INTO TourDate VALUES (
	0002, 0002, TO_DATE('12/06/2010', 'DD/MM/YYYY'), TO_DATE('18/06/2010', 'DD/MM/YYYY')  
);

INSERT INTO TourDate VALUES (
	0003, 0003, TO_DATE('13/06/2010', 'DD/MM/YYYY'), TO_DATE('17/06/2010', 'DD/MM/YYYY')  
);

INSERT INTO TourDate VALUES (
	0004, 0004, TO_DATE('14/06/2010', 'DD/MM/YYYY'), TO_DATE('25/06/2010', 'DD/MM/YYYY')  
);
