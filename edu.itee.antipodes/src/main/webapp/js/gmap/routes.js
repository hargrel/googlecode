...
function addPointItem(lat, lng, pLevel) {
  var displayPoint = new Option('(' + lat + ',' + lng + ')');
...
function createEncodings(moveMap) {
  ...
  document.getElementById('levels').value = encoded_levels;
  document.getElementById('points').value = encoded_points;
...
function decode() {
  var encoded_points = document.getElementById('points').value;
  var encoded_levels = document.getElementById('levels').value;
