...
<h3>Adding Tour Information</h3>
			...
			<br />
			<p><img src="<c:url value="/img/operator_add_tour.PNG"/>" width="690px" /></p>
...
<h3>Aligning Tours with Searches</h3>
			...
			<br />
			<p><img src="<c:url value="/img/operator_align_1.PNG"/>" width="690px" /></p>
			<a href="#Top">Back to top</a>
			<br />
			<br />
			<a name="Criteria"></a>
			...
			<br />
			<p><img src="<c:url value="/img/operator_align_2.PNG"/>" width="690px" /></p>
			<br />
...
<h3>Updating Existing Information</h3>
			...
			<br />
			<p><img src="<c:url value="/img/operator_list.PNG"/>" width="690px" /></p>
			<a href="#Top">Back to top</a>
			<br />
			<br />
			<a name="EditInfo"></a>
			...
			<br />
			<p><img src="<c:url value="/img/operator_edit_tour.PNG"/>" width="690px" /></p>
			<a href="#Top">Back to top</a>
			<br />
			<br />
			<a name="EditRoutes"></a>
			...
			<br />
			<p><img src="<c:url value="/img/operator_delete_tour.PNG"/>" width="690px" /></p>
			<a href="#Top">Back to top</a>
			<br />
