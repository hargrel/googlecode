...
<table border="0" cellspacing="2" style="border-collapse:collapse; padding: 5px">
	...
	<tr>
		...
		<td><input type="text" id="locationName" size="20"/>&nbsp;&nbsp;<input type="button" value="Search" onclick="centerMap()"></td>
	</tr>
	
	<tr>
		<td><div id="map_canvas" style="width: 510px; overflow: hidden; height: 250px; margin:10px 0 0 0"></div>
	...
	<tr>
		<!-- Cancel or submit -->
		<td colspan="2" align="right"><input type="button" value="Cancel" onClick="window.location.href='<c:url value="TOhome.html"/>'" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Next" style="margin-top:30px"/></td>
	</tr>
</table>
</form:form>
</body>
