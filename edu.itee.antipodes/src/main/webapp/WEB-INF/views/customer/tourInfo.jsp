...
<table border="0" align="center" width=100% style="border-collapse:collapse">
	...
	<tr>
		<td><input type="button" value="Contact Tour Operator" style="margin-top: 50px" onClick="window.location.href='<c:url value="contactTourOperator.html?operatorID="/><c:out value="${listedTour.operator.operatorID}"/>'"/></td>
	</tr>
</table>
