...
//		assertNotNull(tourManager.getTours());
	}
	
	public void testGetTours() {
//		List<Tour> tours = tourManager.getTours();
//		assertNotNull(tours);        
//		assertNotNull(tourManager.getTours().size());
//
//		Tour tour = tours.get(tourManager.getTours().size()-1);
//		assertEquals("Testy Tour1 description", tour.getTourDesc());
//
//		tour = tours.get(tourManager.getTours().size());
