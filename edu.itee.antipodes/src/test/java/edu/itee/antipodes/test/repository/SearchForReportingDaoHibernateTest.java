...
import edu.itee.antipodes.repository.SearchForReportingDaoHibernate;

public class SearchForReportingDaoHibernateTest extends TestCase {
	private ApplicationContext ctx = null;
	private SearchForReportingDaoHibernate dao = null;
	...
	public void setUp() throws Exception {
		...
		dao = (SearchForReportingDaoHibernate) ctx.getBean("reportSearchDao");
	}
